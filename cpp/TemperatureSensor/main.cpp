/*----- PROTECTED REGION ID(TemperatureSensor::main.cpp) ENABLED START -----*/
/* clang-format on */
//=============================================================================
//
// file :        main.cpp
//
// description : C++ source for the TemperatureSensor device server main.
...
int main(int argc,char *argv[])
{
	...
	try
	{
		...
		tg->register_dserver_constructor(&TemperatureSensor_ns::constructor);
#endif
...
/* clang-format off */
/*----- PROTECTED REGION END -----*/	//	TemperatureSensor::main.cpp
